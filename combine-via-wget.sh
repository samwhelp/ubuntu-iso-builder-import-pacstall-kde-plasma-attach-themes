...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-kde-plasma-attach-themes"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-attach-themes/iso-profile
"
echo
